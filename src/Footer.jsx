...
const Footer = () => {
    ...
    return (
            ...
            <footer className="d-flex flex-wrap justify-content-center justify-content-sm-between align-items-center py-3 my-4 border-top extra-one">
                <div className="col-md-4 d-flex align-items-center">
                <a href="/" className="mb-3 me-2 mb-md-0 text-muted text-decoration-none lh-1"><Logo></Logo></a>
                <span className="mb-3 mb-md-0">&copy; 2023 X-Rated Films, Inc</span>
                </div>
